  ...
  <div class="m-auto w-full max-w-lg">
      ...
      <form action="{{ route('campaigns.store') }}" method="POST">
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            <input name="email" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-subject" type="text">
          </div>
        </div>
