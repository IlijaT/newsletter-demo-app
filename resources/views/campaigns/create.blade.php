...
<body class="h-screen flex bg-red-200">
  ...
  <div class="m-auto w-full max-w-lg">
    <h1 class="text-purple-500 m-4 text-xl text-center font-bold p-2">Create Newsletter Campaign</h1>
      <form action="{{ route('campaigns.store') }}" method="POST">
        ...
        <div class="md:flex md:items-center mb-6">
          ...
          <div class="md:w-2/3">
            <input name="email" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="text">
          </div>
        </div>
